...
PKGS="gdk-pixbuf2 python-tomlkit python-gobject hyprpolkitagent hyprsunset hyprlauncher $(echo "$JSON_CONTENT" |jq -r '.configs[].packages[]')"
...
chmod +x $USER_HOME/.config/hypr/scripts/hyprsunset/*.sh
